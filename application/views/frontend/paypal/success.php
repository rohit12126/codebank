                            ...
                            <div class="basic-info-wrap">
                                ...
                                <div class="basic-info-content">
                                    ...
                                    <div class="thank-page-section">
                                        ...
                                        <p>Transaction ID : <span><?php echo $result->txn_id; ?></span></p>
                                        <p>Amount Paid : <span class="amount-block">€<?php echo $result->amount; ?></span></p>
                                        ...
                                        <div class="user-sent-info">
                                            ...
                                            <a href="mailto:<?php echo $result->email; ?>" class="user-sent-info-email"><?php echo $result->email; ?></a><br>
